...
//           {/* Logo - absolutely positioned to overflow upwards */}
//     <div className="absolute top-0 -translate-y-1/4 z-10">
//         <a href="#">
//           <img
//             className="h-30 object-contain w-auto mt-10"
//             src="./assets/Logo.svg"
...
//         <a
//           href="#footer"
//           className="bg-brand-accent text-white px-6 py-4 rounded-md text-sm font-serif font-medium hover:opacity-90 transition"
//         >
//           Contact Us
//         </a>
//       </div>
...
//   <img className="h-8" src="assets/Rectangle 147.png" alt="Notch Decoration" />
// </div>
// </header>
